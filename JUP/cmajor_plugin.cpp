...
// Auto-generated Cmajor code for patch 'JUP'
...
//==============================================================================
/// Auto-generated C++ class for the 'JUP' processor
///
...
namespace performer
{
    struct JUP
    {
        ...
        static constexpr std::string_view name = "JUP";
        ...
        static constexpr uint32_t getEndpointHandleForName (std::string_view endpointName)
        {
            ...
            if (endpointName == "lfoDelay")  return static_cast<uint32_t> (EndpointHandles::lfoDelay);
            ...
            if (endpointName == "crossMod")  return static_cast<uint32_t> (EndpointHandles::crossMod);
            if (endpointName == "pwm")       return static_cast<uint32_t> (EndpointHandles::pwm);
            if (endpointName == "pwmMode")   return static_cast<uint32_t> (EndpointHandles::pwmMode);
            ...
            if (endpointName == "filtPol")   return static_cast<uint32_t> (EndpointHandles::filtPol);
        ...
        static constexpr EndpointInfo inputEndpoints[] =
        {
            ...
            { 3,   "lfoDelay",  EndpointType::event },
            { 4,   "lfoShape",  EndpointType::event },
            { 5,   "lfoDepth",  EndpointType::event },
            { 6,   "lfoPitch",  EndpointType::event },
            { 7,   "lfoPwm",    EndpointType::event },
            { 8,   "lfoFilt",   EndpointType::event },
            { 9,   "o1Range",   EndpointType::event },
            { 10,  "o1Wave",    EndpointType::event },
            { 11,  "o2Range",   EndpointType::event },
            { 12,  "o2Fine",    EndpointType::event },
            { 13,  "o2Wave",    EndpointType::event },
            { 14,  "sync",      EndpointType::event },
            { 15,  "crossMod",  EndpointType::event },
            { 16,  "pwm",       EndpointType::event },
            { 17,  "pwmMode",   EndpointType::event },
            { 18,  "mix1",      EndpointType::event },
            { 19,  "mix2",      EndpointType::event },
            { 20,  "hpf",       EndpointType::event },
            { 21,  "cutoff",    EndpointType::event },
            { 22,  "reso",      EndpointType::event },
            { 23,  "slope",     EndpointType::event },
            { 24,  "filtEnv",   EndpointType::event },
            { 25,  "filtPol",   EndpointType::event },
            { 26,  "filtKbd",   EndpointType::event },
            { 27,  "fA",        EndpointType::event },
            { 28,  "fD",        EndpointType::event },
            { 29,  "fS",        EndpointType::event },
            { 30,  "fR",        EndpointType::event },
            { 31,  "aA",        EndpointType::event },
            { 32,  "aD",        EndpointType::event },
            { 33,  "aS",        EndpointType::event },
            { 34,  "aR",        EndpointType::event },
        ...
        struct _JUP_State
        {
            int32_t _sessionID = {};
            double _frequency = {};
            Array<_JupVoice_1_State, 8> voices;
        ...
        struct JUP_State
        {
            ...
            Array<JUP_eventValue_noteOut, 32> noteOut;
        };
        ...
        void addEvent_lfoDelay (float event)
        {
            _sendEvent_lfoDelay (cmajState, event);
        }
        ...
        void addEvent_crossMod (float event)
        {
            _sendEvent_crossMod (cmajState, event);
        }
        ...
        void addEvent_pwmMode (float event)
        {
            _sendEvent_pwmMode (cmajState, event);
        }
        ...
        void addEvent_slope (float event)
        {
        ...
        void addEvent_filtPol (float event)
        {
            _sendEvent_filtPol (cmajState, event);
        }
        ...
        void addEvent (EndpointHandle endpointHandle, uint32_t typeIndex, const unsigned char* eventData)
        {
            ...
            if (endpointHandle == 3)
            {
                ...
                memcpy (&value, eventData, 4);
                eventData += 4;
                return addEvent_lfoDelay (value);
            }
            ...
            if (endpointHandle == 15)
            {
                ...
                memcpy (&value, eventData, 4);
                eventData += 4;
                return addEvent_crossMod (value);
            }
        ...
        //==============================================================================
        void _sendEvent_midiIn (JUP_State& _state, std_midi_Message value) noexcept
        {
            _JUP__midiIn (_state._state, value);
        }

        void _JUP__midiIn (_JUP_State& _state, std_midi_Message value) noexcept
        {
        ...
        {
            _JUP___forwardEvent (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
            _JUP___forwardEvent_5 (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
        }

        void _JUP___forwardEvent (_JUP_State& _state, std_notes_NoteOn value) noexcept
        {
        ...
        {
            _JUP___forwardEvent_3 (state_upcast_struct_JUP_State_struct__x5iJcd(_state), value);
        }

        void _JUP___forwardEvent_3 (_JUP_State& _state, plugincorp_NoteEvent value) noexcept
        {
            _JUP___writeEvent_noteOut (_state, value);
        }

        void _JUP___writeEvent_noteOut (_JUP_State& _state, const plugincorp_NoteEvent& value) noexcept
        {
            JUP___writeEvent_noteOut (state_upcast_struct_JUP_State_struct__4Y8yG(_state), value);
        }

        void JUP___writeEvent_noteOut (JUP_State& _state, const plugincorp_NoteEvent& value) noexcept
        {
            JUP___writeEvent_noteOut_0 (_state, value);
        }

        void JUP___writeEvent_noteOut_0 (JUP_State& _state, const plugincorp_NoteEvent& value) noexcept
        {
        ...
        void _JUP___forwardEvent_5 (_JUP_State& _state, std_notes_NoteOn value) noexcept
        {
        ...
        {
            _JUP___forwardEvent_12 (state_upcast_struct_JUP_State_struct__2Zdkoe(_state), index, value);
        }

        void _JUP___forwardEvent_12 (_JUP_State& _state, int32_t index, std_notes_NoteOff value) noexcept
        {
            JupVoice__eventsIn (_state.voices[index], value);
        }

        void JupVoice__eventsIn (_JupVoice_1_State& _state, std_notes_NoteOff e) noexcept
        {
        ...
        {
            _JUP___forwardEvent_11 (state_upcast_struct_JUP_State_struct__2Zdkoe(_state), index, value);
        }

        void _JUP___forwardEvent_11 (_JUP_State& _state, int32_t index, std_notes_NoteOn value) noexcept
        {
            JupVoice__eventsIn_0 (_state.voices[index], value);
        }

        void JupVoice__eventsIn_0 (_JupVoice_1_State& _state, std_notes_NoteOn e) noexcept
        {
            float  sr;
            float  gt;
            ...
            _state.lfoEnv = 0.0f;
            _state.vDetune = JupVoice__rnd (_state);
            _state.vDrift = JupVoice__rnd (_state);
            _state.vPan = JupVoice__rnd (_state);
        }
        ...
        float JupVoice__rnd (_JupVoice_1_State& _state) noexcept
        {
            float  s;
        ...
        {
            _JUP___forwardEvent_2 (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
            _JUP___forwardEvent_6 (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
        }

        void _JUP___forwardEvent_2 (_JUP_State& _state, std_notes_NoteOff value) noexcept
        {
        ...
        void _JUP___forwardEvent_6 (_JUP_State& _state, std_notes_NoteOff value) noexcept
        {
        ...
        {
            _JUP___forwardEvent_7 (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
        }

        void _JUP___forwardEvent_7 (_JUP_State& _state, std_notes_PitchBend value) noexcept
        {
        ...
        {
            _JUP___forwardEvent_9 (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
        }

        void _JUP___forwardEvent_9 (_JUP_State& _state, std_notes_Pressure value) noexcept
        {
        ...
        {
            _JUP___forwardEvent_8 (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
        }

        void _JUP___forwardEvent_8 (_JUP_State& _state, std_notes_Slide value) noexcept
        {
        ...
        {
            _JUP___forwardEvent_10 (state_upcast_struct_JUP_State_struct__t6gVsd(_state), value);
        }

        void _JUP___forwardEvent_10 (_JUP_State& _state, std_notes_Control value) noexcept
        {
        ...
        void _sendEvent_lfoRate (JUP_State& _state, float value) noexcept
        {
            _JUP__lfoRate (_state._state, value);
        }

        void _JUP__lfoRate (_JUP_State& _state, float value) noexcept
        {
        ...
        {
            _JUP___forwardEvent_4 (state_upcast_struct_JUP_State_struct__R60Yed(_state), value);
        }

        void _JUP___forwardEvent_4 (_JUP_State& _state, plugincorp_Params value) noexcept
        {
            int32_t  i;

            {
                ...
                for (;;)
                {
                    ...
                    JupVoice__paramsIn (_state.voices[i], value);
                    {
                        ++i;
                    }
                }
        ...
        void JupVoice__paramsIn (_JupVoice_1_State& _state, plugincorp_Params p) noexcept
        {
            _state.params = p;
        }

        void _sendEvent_lfoDelay (JUP_State& _state, float value) noexcept
        {
            _JUP__lfoDelay (_state._state, value);
        }

        void _JUP__lfoDelay (_JUP_State& _state, float value) noexcept
        {
            ParamsProcessor__lfoDelay (_state.paramsProcessor, value);
        }

        void ParamsProcessor__lfoDelay (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.lfoDelay = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_lfoShape (JUP_State& _state, float value) noexcept
        {
            _JUP__lfoShape (_state._state, value);
        }

        void _JUP__lfoShape (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_lfoDepth (JUP_State& _state, float value) noexcept
        {
            _JUP__lfoDepth (_state._state, value);
        }

        void _JUP__lfoDepth (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_lfoPitch (JUP_State& _state, float value) noexcept
        {
            _JUP__lfoPitch (_state._state, value);
        }

        void _JUP__lfoPitch (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_lfoPwm (JUP_State& _state, float value) noexcept
        {
            _JUP__lfoPwm (_state._state, value);
        }

        void _JUP__lfoPwm (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_lfoFilt (JUP_State& _state, float value) noexcept
        {
            _JUP__lfoFilt (_state._state, value);
        }

        void _JUP__lfoFilt (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_o1Range (JUP_State& _state, float value) noexcept
        {
            _JUP__o1Range (_state._state, value);
        }

        void _JUP__o1Range (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_o1Wave (JUP_State& _state, float value) noexcept
        {
            _JUP__o1Wave (_state._state, value);
        }

        void _JUP__o1Wave (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_o2Range (JUP_State& _state, float value) noexcept
        {
            _JUP__o2Range (_state._state, value);
        }

        void _JUP__o2Range (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_o2Fine (JUP_State& _state, float value) noexcept
        {
            _JUP__o2Fine (_state._state, value);
        }

        void _JUP__o2Fine (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_o2Wave (JUP_State& _state, float value) noexcept
        {
            _JUP__o2Wave (_state._state, value);
        }

        void _JUP__o2Wave (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_sync (JUP_State& _state, float value) noexcept
        {
            _JUP__sync (_state._state, value);
        }

        void _JUP__sync (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_crossMod (JUP_State& _state, float value) noexcept
        {
            _JUP__crossMod (_state._state, value);
        }

        void _JUP__crossMod (_JUP_State& _state, float value) noexcept
        {
            ParamsProcessor__crossMod (_state.paramsProcessor, value);
        }

        void ParamsProcessor__crossMod (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.crossMod = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_pwm (JUP_State& _state, float value) noexcept
        {
            _JUP__pwm (_state._state, value);
        }

        void _JUP__pwm (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_pwmMode (JUP_State& _state, float value) noexcept
        {
            _JUP__pwmMode (_state._state, value);
        }

        void _JUP__pwmMode (_JUP_State& _state, float value) noexcept
        {
            ParamsProcessor__pwmMode (_state.paramsProcessor, value);
        }

        void ParamsProcessor__pwmMode (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.pwmMode = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_mix1 (JUP_State& _state, float value) noexcept
        {
            _JUP__mix1 (_state._state, value);
        }

        void _JUP__mix1 (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_mix2 (JUP_State& _state, float value) noexcept
        {
            _JUP__mix2 (_state._state, value);
        }

        void _JUP__mix2 (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_hpf (JUP_State& _state, float value) noexcept
        {
            _JUP__hpf (_state._state, value);
        }

        void _JUP__hpf (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_cutoff (JUP_State& _state, float value) noexcept
        {
            _JUP__cutoff (_state._state, value);
        }

        void _JUP__cutoff (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_reso (JUP_State& _state, float value) noexcept
        {
            _JUP__reso (_state._state, value);
        }

        void _JUP__reso (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_slope (JUP_State& _state, float value) noexcept
        {
            _JUP__slope (_state._state, value);
        }

        void _JUP__slope (_JUP_State& _state, float value) noexcept
        {
            ParamsProcessor__slope (_state.paramsProcessor, value);
        }

        void ParamsProcessor__slope (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.slope = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_filtEnv (JUP_State& _state, float value) noexcept
        {
            _JUP__filtEnv (_state._state, value);
        }

        void _JUP__filtEnv (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_filtPol (JUP_State& _state, float value) noexcept
        {
            _JUP__filtPol (_state._state, value);
        }

        void _JUP__filtPol (_JUP_State& _state, float value) noexcept
        {
            ParamsProcessor__filtPol (_state.paramsProcessor, value);
        }

        void ParamsProcessor__filtPol (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.filtPol = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_filtKbd (JUP_State& _state, float value) noexcept
        {
            _JUP__filtKbd (_state._state, value);
        }

        void _JUP__filtKbd (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_fA (JUP_State& _state, float value) noexcept
        {
            _JUP__fA (_state._state, value);
        }

        void _JUP__fA (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_fD (JUP_State& _state, float value) noexcept
        {
            _JUP__fD (_state._state, value);
        }

        void _JUP__fD (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_fS (JUP_State& _state, float value) noexcept
        {
            _JUP__fS (_state._state, value);
        }

        void _JUP__fS (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_fR (JUP_State& _state, float value) noexcept
        {
            _JUP__fR (_state._state, value);
        }

        void _JUP__fR (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aA (JUP_State& _state, float value) noexcept
        {
            _JUP__aA (_state._state, value);
        }

        void _JUP__aA (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aD (JUP_State& _state, float value) noexcept
        {
            _JUP__aD (_state._state, value);
        }

        void _JUP__aD (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aS (JUP_State& _state, float value) noexcept
        {
            _JUP__aS (_state._state, value);
        }

        void _JUP__aS (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aR (JUP_State& _state, float value) noexcept
        {
            _JUP__aR (_state._state, value);
        }

        void _JUP__aR (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_detune (JUP_State& _state, float value) noexcept
        {
            _JUP__detune (_state._state, value);
        }

        void _JUP__detune (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_glide (JUP_State& _state, float value) noexcept
        {
            _JUP__glide (_state._state, value);
        }

        void _JUP__glide (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_volume (JUP_State& _state, float value) noexcept
        {
            _JUP__volume (_state._state, value);
        }

        void _JUP__volume (_JUP_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_tune (JUP_State& _state, float value) noexcept
        {
            _JUP__tune (_state._state, value);
        }

        void _JUP__tune (_JUP_State& _state, float value) noexcept
        {
        ...
        void _initialise (JUP_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            _JUP___initialise (_state._state, processorID, sessionID, frequency);
        }

        void _JUP___initialise (_JUP_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            int32_t  i;
            ...
            g__frequency = frequency;
            {
                ...
                for (;;)
                {
                    ...
                    JupVoice___initialise (_state.voices[i], processorID, sessionID, frequency);
                    {
                        ++i;
                    }
                }
        ...
        void JupVoice___initialise (_JupVoice_1_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            g__sessionID = sessionID;
            g__frequency = frequency;
        ...
        void ParamsProcessor___initialise (_ParamsProcessor_1_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            g__sessionID = sessionID;
            g__frequency = frequency;
            _state.params = plugincorp_Params { 0.3f, 0.0f, 0.0f, 0.25f, 0.0f, 0.0f, 0.0f, 0.5f, 0.0f, 0.5f, 0.5f, 0.0f, 0.0f, 0.0f, 0.5f, 0.0f, 0.8f, 0.7f, 0.0f, 0.6f, 0.15f, 1.0f, 0.4f, 0.0f, 0.3f, 0.02f, 0.5f, 0.3f, 0.3f, 0.02f, 0.5f, 0.85f, 0.25f, 0.18f, 0.0f, 0.8f, 0.5f };
        }
        ...
        void _advance (JUP_State& _state, JUP_IO& _io, int32_t _frames) noexcept
        {
            _JUP_IO  ioCopy;
        ...
        void main (_JUP_State& _state, _JUP_IO& _io) noexcept
        {
            Array<_JupVoice_1_IO, 8>  voices_io;
            ...
            voices_io = Array<_JupVoice_1_IO, 8> {};
            ...
            }
            {
                ...
                for (;;)
                {
                    ...
                    JupVoice__main (_state.voices[i], voices_io[i]);
                    {
                        ++i;
                    }
                }
        ...
        void JupVoice__main (_JupVoice_1_State& _state, _JupVoice_1_IO& _io) noexcept
        {
            float  outL;
            float  outR;
            float  driftC;
            ...
            _state.drift = JupVoice__rnd (_state);
            _branch0_0:
            {
                for (;;)
                {
                    ...
                    if (_state.active)
                    {
                        _state.driftPh = (_state.driftPh + (4.0f * _state.invSr));
                        if (_state.driftPh >= 1.0f)
                        {
                            _state.driftPh = (_state.driftPh - 1.0f);
                            _state.drift = JupVoice__rnd (_state);
                        }
                        driftC = 1.0f + ((_state.drift * 0.0004f) + (_state.vDrift * 0.0003f));
                        ...
                        if (_state.shPh >= 1.0f)
                        {
                            ...
                            _state.shVal = JupVoice__rnd (_state);
                        }
                        ...
                        else
                        {
                            if (_state.params.lfoShape < 0.67f)
                            {
                                ...
                                lfo = ((lsq * (1.0f - m_0)) + (lsaw * m_0));
                            }
                            else
                            {
                                m_1 = (_state.params.lfoShape - 0.67f) / 0.33f;
                                lfo = ((lsaw * (1.0f - m_1)) + (_state.shVal * m_1));
                            }
                        }
                        delayRate = 1.0f / (intrinsics::max (0.001f, 0.001f + ((_state.params.lfoDelay * _state.params.lfoDelay) * 4.0f)) * _state.sr);
                        _state.lfoEnv = (_state.lfoEnv + delayRate);
                        if (_state.lfoEnv > 1.0f)
                        {
                            _state.lfoEnv = 1.0f;
                        }
                        lfoAmt = (lfo * _state.lfoEnv) * _state.params.lfoDepth;
                        e1a = 1.0f / (intrinsics::max (0.0005f, 0.0008f + ((_state.params.fA * _state.params.fA) * 3.5f)) * _state.sr);
                        e1d = 1.0f / (intrinsics::max (0.0005f, 0.003f + ((_state.params.fD * _state.params.fD) * 8.0f)) * _state.sr);
                        e1r = 1.0f / (intrinsics::max (0.0005f, 0.003f + ((_state.params.fR * _state.params.fR) * 8.0f)) * _state.sr);
                        ...
                        else
                        {
                            if (_state.e1Stage == int32_t {1})
                            {
                                ...
                                if (_state.e1 <= _state.params.fS)
                                {
                                    _state.e1 = _state.params.fS;
                        ...
                        e2a = 1.0f / (intrinsics::max (0.0005f, 0.0008f + ((_state.params.aA * _state.params.aA) * 3.5f)) * _state.sr);
                        e2d = 1.0f / (intrinsics::max (0.0005f, 0.003f + ((_state.params.aD * _state.params.aD) * 8.0f)) * _state.sr);
                        e2r = 1.0f / (intrinsics::max (0.0005f, 0.003f + ((_state.params.aR * _state.params.aR) * 8.0f)) * _state.sr);
                        ...
                        else
                        {
                            if (_state.e2Stage == int32_t {1})
                            {
                                ...
                                if (_state.e2 <= _state.params.aS)
                                {
                                    _state.e2 = _state.params.aS;
                        ...
                        if (_state.params.lfoPitch > 0.5f)
                        {
                        ...
                        pitchBase = (pitchBase * intrinsics::pow (2.0f, (_state.vDetune * _state.params.detune) * 0.04f));
                        pw = _state.params.pwm;
                        if ((_state.params.pwmMode < 0.5f) ? (_state.params.lfoPwm > 0.5f) : false)
                        {
                            pw = (pw + (lfoAmt * 0.4f));
                        }
                        pw = intrinsics::clamp (pw, 0.05f, 0.95f);
                        w1 = static_cast<int32_t> (intrinsics::clamp (intrinsics::floor (_state.params.o1Wave * 3.0f), 0.0f, 2.0f));
                        w2 = static_cast<int32_t> (intrinsics::clamp (intrinsics::floor (_state.params.o2Wave * 4.0f), 0.0f, 3.0f));
                        oct2 = intrinsics::pow (2.0f, intrinsics::floor (((_state.params.o2Range - 0.5f) * 4.0f) + 0.5f));
                        fine = (_state.params.o2Fine - 0.5f) * 0.16f;
                        ...
                        if (w2 == int32_t {3})
                        {
                            _temp = JupVoice__rnd (_state);
                        }
                        else
                        {
                            _temp = JupVoice__oscWave (_state.ph2, inc2, w2, pw);
                        }
                        o2 = _temp;
                        oct1 = intrinsics::pow (2.0f, intrinsics::floor (((_state.params.o1Range - 0.5f) * 4.0f) + 0.5f));
                        f1 = pitchBase * oct1;
                        if (_state.params.crossMod > 0.5f)
                        {
                            f1 = (f1 * intrinsics::pow (2.0f, (_state.o2prev * _state.params.crossMod) * 0.9f));
                        }
                        ...
                        o1 = JupVoice__oscWave (_state.ph1, inc1, w1, pw);
                        _state.o2prev = o2;
                        ...
                        _state.dcy = yb;
                        sig = yb;
                        hpHz = (_state.params.hpf < 0.02f) ? 0.0f : (20.0f * intrinsics::exp (_state.params.hpf * 4.6f));
                        if (hpHz > 1.0f)
                        {
                            rc = 1.0f / (1.0f + ((6.2831855f * hpHz) * _state.invSr));
                            y = rc * ((_state.hpY + sig) - _state.hpX);
                            _state.hpX = sig;
                            _state.hpY = y;
                            sig = y;
                        }
                        ...
                        envSign = (_state.params.filtPol < 0.5f) ? 1.0f : -1.0f;
                        envHz = ((_state.params.filtEnv * _state.e1) * envSign) * 8000.0f;
                        lfoHzC = (_state.params.lfoFilt > 0.5f) ? (lfoAmt * 3500.0f) : 0.0f;
                        fc = ((kHz + envHz) + lfoHzC) * track;
                        fc = (fc * (1.0f + (_state.vDrift * 0.006f)));
                        ...
                        mode12 = _state.params.slope < 0.5f;
                        res = _state.params.reso * (mode12 ? 3.7f : 4.3f);
                        fbRaw = mode12 ? _state.y2 : _state.y4;
                        fb = fbRaw / (1.0f + ((0.15f * fbRaw) * fbRaw));
                        x = sig - (res * fb);
                        ...
                        _state.y4 = (_state.y4 / (1.0f + ((0.15f * _state.y4) * _state.y4)));
                        _state.ox = x;
                        _state.oy1 = _state.y1;
                        _state.oy2 = _state.y2;
                        _state.oy3 = _state.y3;
                        filtOut = mode12 ? ((_state.y2 / (1.0f + ((0.15f * _state.y2) * _state.y2))) * 1.2f) : _state.y4;
                        amp = ((filtOut * _state.e2) * (0.4f + (0.6f * _state.vel))) * (0.4f + (_state.params.volume * 1.1f));
                        pan = (_state.vPan * _state.params.detune) * 0.5f;
        ...
        float JupVoice__oscWave (float ph, float inc, int32_t wave, float pw) noexcept
        {
            float  saw;
            float  p2;
            float  saw2;
            ...
            return ((2.0f * ph) - 1.0f) - toi__dsp__polyBlep (ph, inc);
        }
        ...
        static _JUP_State& state_upcast_struct_JUP_State_struct__2Zdkoe (std_voices_std_voices_VoiceAllocator_specialised_Th5A4_1_State& child) { return *reinterpret_cast<_JUP_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_JUP_State, voiceAllocator))); }
        static JUP_State& state_upcast_struct_JUP_State_struct__4Y8yG (_JUP_State& child) { return *reinterpret_cast<JUP_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (JUP_State, _state))); }
        static _JUP_State& state_upcast_struct_JUP_State_struct__x5iJcd (std_midi_MPEConverter_1_State& child) { return *reinterpret_cast<_JUP_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_JUP_State, noteTap))); }
        static _JUP_State& state_upcast_struct_JUP_State_struct__R60Yed (_ParamsProcessor_1_State& child) { return *reinterpret_cast<_JUP_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_JUP_State, paramsProcessor))); }
        static _JUP_State& state_upcast_struct_JUP_State_struct__t6gVsd (std_midi_MPEConverter_1_State& child) { return *reinterpret_cast<_JUP_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_JUP_State, mpe))); }
...
struct JUP
{
    using PerformerClass = performer::JUP;
    static constexpr auto filename = "JUP.cmajorpatch";
    ...
    static constexpr const char* cmaj_api_cmajpatchconnection_js =
        ...
        "    }\n"
        "}\n";
    static constexpr const char* JUP_cmajorpatch =
        "{\n"
        "  \"CmajorVersion\": 1,\n"
        "  \"ID\": \"com.plugincorp.jwjup\",\n"
        "  \"version\": \"0.1\",\n"
        "  \"name\": \"JW-JUP\",\n"
        "  \"description\": \"TOI JW-JUP - luxury 8-voice analog poly by plugin corp\",\n"
        "  \"category\": \"instrument\",\n"
        "  \"manufacturer\": \"TOI\",\n"
        "  \"isInstrument\": true,\n"
    ...
    static constexpr std::array files =
    {
        ...
        File { "JUP.cmajorpatch", std::string_view (JUP_cmajorpatch, 368) },
...
// native faceplate (replaces the generic Cmajor UI). See JUPNative.h.
#include "JUPNative.h"

juce::AudioProcessor* JUCE_CALLTYPE createPluginFilter()
{
    return new JupPlugin (std::make_shared<cmaj::Patch>());
}
