...
public:
    ...
    void paintButton (juce::Graphics& g, bool over, bool down) override
    {
        ...
        // moulded frame (recessed groove around the cap)
        ...
        g.setColour (over && ! lit ? juce::Colours::white.withAlpha (0.12f) : juce::Colours::black.withAlpha (0.0f));
        g.fillRoundedRectangle (inner, 2.2f);
