...
// Auto-generated Cmajor code for patch 'PPG'
...
//==============================================================================
/// Auto-generated C++ class for the 'PPG' processor
///
...
namespace performer
{
    struct PPG
    {
        ...
        static constexpr std::string_view name = "PPG";
        ...
        //==============================================================================
        static constexpr uint32_t numInputEndpoints  = 26;
        ...
        static constexpr uint32_t getEndpointHandleForName (std::string_view endpointName)
        {
            ...
            if (endpointName == "waveEnv")   return static_cast<uint32_t> (EndpointHandles::waveEnv);
            ...
            if (endpointName == "res")       return static_cast<uint32_t> (EndpointHandles::res);
            if (endpointName == "filtEnv")   return static_cast<uint32_t> (EndpointHandles::filtEnv);
            if (endpointName == "keytrk")    return static_cast<uint32_t> (EndpointHandles::keytrk);
        ...
        static constexpr EndpointInfo inputEndpoints[] =
        {
            ...
            { 4,   "waveEnv",   EndpointType::event },
            { 5,   "waveLfo",   EndpointType::event },
            { 6,   "detune",    EndpointType::event },
            { 7,   "mix",       EndpointType::event },
            { 8,   "sub",       EndpointType::event },
            { 9,   "noise",     EndpointType::event },
            { 10,  "grit",      EndpointType::event },
            { 11,  "cutoff",    EndpointType::event },
            { 12,  "res",       EndpointType::event },
            { 13,  "filtEnv",   EndpointType::event },
            { 14,  "keytrk",    EndpointType::event },
            { 15,  "fA",        EndpointType::event },
            { 16,  "fD",        EndpointType::event },
            { 17,  "fS",        EndpointType::event },
            { 18,  "fR",        EndpointType::event },
            { 19,  "aA",        EndpointType::event },
            { 20,  "aD",        EndpointType::event },
            { 21,  "aS",        EndpointType::event },
            { 22,  "aR",        EndpointType::event },
            { 23,  "lfoRate",   EndpointType::event },
            { 24,  "lfoShape",  EndpointType::event },
            { 25,  "volume",    EndpointType::event },
            { 26,  "tune",      EndpointType::event }
        };

        static constexpr EndpointInfo outputEndpoints[] =
        {
            { 27,  "audioOut",  EndpointType::stream },
            { 28,  "noteOut",   EndpointType::event  }
        };
        ...
        struct _PPGVoice_1_State
        {
            plugincorp_Params params;
            Array<float, 16384> wt;
            bool active = {};
            float freq = {};
            float vel = {};
            float phA = {};
        ...
        struct _PPG_State
        {
            int32_t _sessionID = {};
            double _frequency = {};
            Array<_PPGVoice_1_State, 8> voices;
        ...
        struct PPG_State
        {
            ...
            Array<PPG_eventValue_noteOut, 32> noteOut;
        };
        ...
        {
            if (endpointHandle == 27) { std::memcpy (reinterpret_cast<char*> (dest), std::addressof (cmajIO.audioOut), 8 * numFramesToCopy); std::memset (reinterpret_cast<char*> (std::addressof (cmajIO.audioOut)), 0, 8 * numFramesToCopy); return; }
        ...
        {
            if (endpointHandle == 28) return (uint32_t) cmajState.noteOut_eventCount;
        ...
        {
            if (endpointHandle == 28) { cmajState.noteOut_eventCount = 0; return; }
        }

        uint32_t getOutputEventType (EndpointHandle endpointHandle, uint32_t index)
        {
            if (endpointHandle == 28) return (uint32_t) cmajState.noteOut[(IndexType) index].type;
            throw std::runtime_error ("Unknown event endpointHandle:" + std::to_string (endpointHandle));
            return {};
        }
        ...
        static uint32_t getOutputEventDataSize (EndpointHandle endpointHandle, uint32_t typeIndex)
        {
            ...
            if (endpointHandle == 28 && typeIndex == 0) return 8;
            throw std::runtime_error ("Unknown event endpointHandle:" + std::to_string (endpointHandle));
            return 0;
        }
        ...
        void addEvent_waveEnv (float event)
        {
            _sendEvent_waveEnv (cmajState, event);
        }
        ...
        void addEvent_res (float event)
        {
            _sendEvent_res (cmajState, event);
        }
        ...
        void addEvent_keytrk (float event)
        {
            _sendEvent_keytrk (cmajState, event);
        }
        ...
        //==============================================================================
        void _sendEvent_midiIn (PPG_State& _state, std_midi_Message value) noexcept
        {
            _PPG__midiIn (_state._state, value);
        }

        void _PPG__midiIn (_PPG_State& _state, std_midi_Message value) noexcept
        {
        ...
        {
            _PPG___forwardEvent (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
            _PPG___forwardEvent_5 (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
        }

        void _PPG___forwardEvent (_PPG_State& _state, std_notes_NoteOn value) noexcept
        {
        ...
        {
            _PPG___forwardEvent_3 (state_upcast_struct_PPG_State_struct__lKHNAe(_state), value);
        }

        void _PPG___forwardEvent_3 (_PPG_State& _state, plugincorp_NoteEvent value) noexcept
        {
            _PPG___writeEvent_noteOut (_state, value);
        }

        void _PPG___writeEvent_noteOut (_PPG_State& _state, const plugincorp_NoteEvent& value) noexcept
        {
            PPG___writeEvent_noteOut (state_upcast_struct_PPG_State_struct__HUIvTb(_state), value);
        }

        void PPG___writeEvent_noteOut (PPG_State& _state, const plugincorp_NoteEvent& value) noexcept
        {
            PPG___writeEvent_noteOut_0 (_state, value);
        }

        void PPG___writeEvent_noteOut_0 (PPG_State& _state, const plugincorp_NoteEvent& value) noexcept
        {
        ...
        void _PPG___forwardEvent_5 (_PPG_State& _state, std_notes_NoteOn value) noexcept
        {
        ...
        {
            _PPG___forwardEvent_12 (state_upcast_struct_PPG_State_struct__DVMcGd(_state), index, value);
        }

        void _PPG___forwardEvent_12 (_PPG_State& _state, int32_t index, std_notes_NoteOff value) noexcept
        {
            PPGVoice__eventsIn (_state.voices[index], value);
        }

        void PPGVoice__eventsIn (_PPGVoice_1_State& _state, std_notes_NoteOff e) noexcept
        {
            _state.feStage = int32_t {3};
            _state.aeStage = int32_t {3};
        }
        ...
        {
            _PPG___forwardEvent_11 (state_upcast_struct_PPG_State_struct__DVMcGd(_state), index, value);
        }

        void _PPG___forwardEvent_11 (_PPG_State& _state, int32_t index, std_notes_NoteOn value) noexcept
        {
            PPGVoice__eventsIn_0 (_state.voices[index], value);
        }

        void PPGVoice__eventsIn_0 (_PPGVoice_1_State& _state, std_notes_NoteOn e) noexcept
        {
            _state.freq = std__notes__noteToFrequency (e.pitch);
            _state.vel = e.velocity;
            _state.active = true;
            _state.feStage = int32_t {0};
            _state.aeStage = int32_t {0};
            _state.vPan = PPGVoice__rnd (_state);
        }
        ...
        float PPGVoice__rnd (_PPGVoice_1_State& _state) noexcept
        {
            float  s;
        ...
        {
            _PPG___forwardEvent_2 (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
            _PPG___forwardEvent_6 (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
        }

        void _PPG___forwardEvent_2 (_PPG_State& _state, std_notes_NoteOff value) noexcept
        {
        ...
        void _PPG___forwardEvent_6 (_PPG_State& _state, std_notes_NoteOff value) noexcept
        {
        ...
        {
            _PPG___forwardEvent_7 (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
        }

        void _PPG___forwardEvent_7 (_PPG_State& _state, std_notes_PitchBend value) noexcept
        {
        ...
        {
            _PPG___forwardEvent_9 (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
        }

        void _PPG___forwardEvent_9 (_PPG_State& _state, std_notes_Pressure value) noexcept
        {
        ...
        {
            _PPG___forwardEvent_8 (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
        }

        void _PPG___forwardEvent_8 (_PPG_State& _state, std_notes_Slide value) noexcept
        {
        ...
        {
            _PPG___forwardEvent_10 (state_upcast_struct_PPG_State_struct__KHvoye(_state), value);
        }

        void _PPG___forwardEvent_10 (_PPG_State& _state, std_notes_Control value) noexcept
        {
        ...
        void _sendEvent_waveA (PPG_State& _state, float value) noexcept
        {
            _PPG__waveA (_state._state, value);
        }

        void _PPG__waveA (_PPG_State& _state, float value) noexcept
        {
        ...
        {
            _PPG___forwardEvent_4 (state_upcast_struct_PPG_State_struct__DM9Mxc(_state), value);
        }

        void _PPG___forwardEvent_4 (_PPG_State& _state, plugincorp_Params value) noexcept
        {
            int32_t  i;

            {
                ...
                for (;;)
                {
                    ...
                    PPGVoice__paramsIn (_state.voices[i], value);
                    {
                        ++i;
                    }
                }
        ...
        void PPGVoice__paramsIn (_PPGVoice_1_State& _state, plugincorp_Params p) noexcept
        {
            _state.params = p;
        }

        void _sendEvent_waveB (PPG_State& _state, float value) noexcept
        {
            _PPG__waveB (_state._state, value);
        }

        void _PPG__waveB (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_waveEnv (PPG_State& _state, float value) noexcept
        {
            _PPG__waveEnv (_state._state, value);
        }

        void _PPG__waveEnv (_PPG_State& _state, float value) noexcept
        {
            ParamsProcessor__waveEnv (_state.paramsProcessor, value);
        }

        void ParamsProcessor__waveEnv (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.waveEnv = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_waveLfo (PPG_State& _state, float value) noexcept
        {
            _PPG__waveLfo (_state._state, value);
        }

        void _PPG__waveLfo (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_detune (PPG_State& _state, float value) noexcept
        {
            _PPG__detune (_state._state, value);
        }

        void _PPG__detune (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_mix (PPG_State& _state, float value) noexcept
        {
            _PPG__mix (_state._state, value);
        }

        void _PPG__mix (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_sub (PPG_State& _state, float value) noexcept
        {
            _PPG__sub (_state._state, value);
        }

        void _PPG__sub (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_noise (PPG_State& _state, float value) noexcept
        {
            _PPG__noise (_state._state, value);
        }

        void _PPG__noise (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_grit (PPG_State& _state, float value) noexcept
        {
            _PPG__grit (_state._state, value);
        }

        void _PPG__grit (_PPG_State& _state, float value) noexcept
        {
            ParamsProcessor__grit (_state.paramsProcessor, value);
        }

        void ParamsProcessor__grit (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.grit = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_cutoff (PPG_State& _state, float value) noexcept
        {
            _PPG__cutoff (_state._state, value);
        }

        void _PPG__cutoff (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_res (PPG_State& _state, float value) noexcept
        {
            _PPG__res (_state._state, value);
        }

        void _PPG__res (_PPG_State& _state, float value) noexcept
        {
            ParamsProcessor__res (_state.paramsProcessor, value);
        }

        void ParamsProcessor__res (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.res = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_filtEnv (PPG_State& _state, float value) noexcept
        {
            _PPG__filtEnv (_state._state, value);
        }

        void _PPG__filtEnv (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_keytrk (PPG_State& _state, float value) noexcept
        {
            _PPG__keytrk (_state._state, value);
        }

        void _PPG__keytrk (_PPG_State& _state, float value) noexcept
        {
            ParamsProcessor__keytrk (_state.paramsProcessor, value);
        }

        void ParamsProcessor__keytrk (_ParamsProcessor_1_State& _state, float v) noexcept
        {
            _state.params.keytrk = v;
            ParamsProcessor___writeEvent_paramsOut (_state, _state.params);
        }

        void _sendEvent_fA (PPG_State& _state, float value) noexcept
        {
            _PPG__fA (_state._state, value);
        }

        void _PPG__fA (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_fD (PPG_State& _state, float value) noexcept
        {
            _PPG__fD (_state._state, value);
        }

        void _PPG__fD (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_fS (PPG_State& _state, float value) noexcept
        {
            _PPG__fS (_state._state, value);
        }

        void _PPG__fS (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_fR (PPG_State& _state, float value) noexcept
        {
            _PPG__fR (_state._state, value);
        }

        void _PPG__fR (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aA (PPG_State& _state, float value) noexcept
        {
            _PPG__aA (_state._state, value);
        }

        void _PPG__aA (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aD (PPG_State& _state, float value) noexcept
        {
            _PPG__aD (_state._state, value);
        }

        void _PPG__aD (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aS (PPG_State& _state, float value) noexcept
        {
            _PPG__aS (_state._state, value);
        }

        void _PPG__aS (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_aR (PPG_State& _state, float value) noexcept
        {
            _PPG__aR (_state._state, value);
        }

        void _PPG__aR (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_lfoRate (PPG_State& _state, float value) noexcept
        {
            _PPG__lfoRate (_state._state, value);
        }

        void _PPG__lfoRate (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_lfoShape (PPG_State& _state, float value) noexcept
        {
            _PPG__lfoShape (_state._state, value);
        }

        void _PPG__lfoShape (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_volume (PPG_State& _state, float value) noexcept
        {
            _PPG__volume (_state._state, value);
        }

        void _PPG__volume (_PPG_State& _state, float value) noexcept
        {
        ...
        void _sendEvent_tune (PPG_State& _state, float value) noexcept
        {
            _PPG__tune (_state._state, value);
        }

        void _PPG__tune (_PPG_State& _state, float value) noexcept
        {
        ...
        void _initialise (PPG_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            _PPG___initialise (_state._state, processorID, sessionID, frequency);
        }

        void _PPG___initialise (_PPG_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            int32_t  i;
            ...
            g__frequency = frequency;
            {
                ...
                for (;;)
                {
                    ...
                    PPGVoice___initialise (_state.voices[i], processorID, sessionID, frequency);
                    {
                        ++i;
                    }
                }
        ...
        void PPGVoice___initialise (_PPGVoice_1_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            g__sessionID = sessionID;
            g__frequency = frequency;
            ...
            _state.vel = 0.0f;
            _state.active = false;
            _state.feStage = int32_t {-1};
            _state.aeStage = int32_t {-1};
            _state.vPan = 0.0f;
            _state.lfoPh = 0.0f;
            _state.fe = 0.0f;
            _state.ae = 0.0f;
        ...
        void ParamsProcessor___initialise (_ParamsProcessor_1_State& _state, int32_t& processorID, int32_t sessionID, double frequency) noexcept
        {
            g__sessionID = sessionID;
            g__frequency = frequency;
            _state.params = plugincorp_Params { 0.15f, 0.2f, 0.45f, 0.1f, 0.18f, 0.5f, 0.0f, 0.0f, 0.0f, 0.72f, 0.18f, 0.4f, 0.3f, 0.1f, 0.45f, 0.4f, 0.4f, 0.06f, 0.5f, 0.8f, 0.4f, 0.3f, 0.0f, 0.8f, 0.5f };
        }
        ...
        void _advance (PPG_State& _state, PPG_IO& _io, int32_t _frames) noexcept
        {
            _PPG_IO  ioCopy;
        ...
        void main (_PPG_State& _state, _PPG_IO& _io) noexcept
        {
            Array<_PPGVoice_1_IO, 8>  voices_io;
            ...
            voices_io = Array<_PPGVoice_1_IO, 8> {};
            ...
            }
            {
                ...
                for (;;)
                {
                    ...
                    PPGVoice__main (_state.voices[i], voices_io[i]);
                    {
                        ++i;
                    }
                }
        ...
        void PPGVoice__main (_PPGVoice_1_State& _state, _PPGVoice_1_IO& _io) noexcept
        {
            float  outL;
            float  outR;
            float  lfoHz;
            ...
            _branch0_0:
            {
                for (;;)
                {
                    ...
                    if (_state.active)
                    {
                        ...
                        faT = 1.0f / (intrinsics::max (0.0006f, 0.002f + ((_state.params.fA * _state.params.fA) * 5.0f)) * _state.sr);
                        fdT = 1.0f / (intrinsics::max (0.0006f, 0.006f + ((_state.params.fD * _state.params.fD) * 8.0f)) * _state.sr);
                        frT = 1.0f / (intrinsics::max (0.0006f, 0.006f + ((_state.params.fR * _state.params.fR) * 8.0f)) * _state.sr);
                        if (_state.feStage == int32_t {0})
                        {
                            _state.fe = (_state.fe + faT);
                            if (_state.fe >= 1.0f)
                            {
                                _state.fe = 1.0f;
                                _state.feStage = int32_t {1};
                        ...
                        {
                            if (_state.feStage == int32_t {1})
                            {
                                _state.fe = (_state.fe - fdT);
                                if (_state.fe <= _state.params.fS)
                                {
                                    _state.fe = _state.params.fS;
                                    _state.feStage = int32_t {2};
                                }
                            }
                            else
                            {
                                if (_state.feStage == int32_t {2})
                                {
                                    _state.fe = _state.params.fS;
                                }
                                else
                                {
                                    if (_state.feStage == int32_t {3})
                                    {
                                        _state.fe = (_state.fe - frT);
                                        if (_state.fe <= 0.0f)
                                        {
                                            _state.fe = 0.0f;
                                            _state.feStage = int32_t {-1};
                        ...
                        aaT = 1.0f / (intrinsics::max (0.0006f, 0.002f + ((_state.params.aA * _state.params.aA) * 5.0f)) * _state.sr);
                        adT = 1.0f / (intrinsics::max (0.0006f, 0.006f + ((_state.params.aD * _state.params.aD) * 8.0f)) * _state.sr);
                        arT = 1.0f / (intrinsics::max (0.0006f, 0.006f + ((_state.params.aR * _state.params.aR) * 8.0f)) * _state.sr);
                        if (_state.aeStage == int32_t {0})
                        {
                            _state.ae = (_state.ae + aaT);
                            if (_state.ae >= 1.0f)
                            {
                                _state.ae = 1.0f;
                                _state.aeStage = int32_t {1};
                        ...
                        {
                            if (_state.aeStage == int32_t {1})
                            {
                                _state.ae = (_state.ae - adT);
                                if (_state.ae <= _state.params.aS)
                                {
                                    _state.ae = _state.params.aS;
                                    _state.aeStage = int32_t {2};
                                }
                            }
                            else
                            {
                                if (_state.aeStage == int32_t {2})
                                {
                                    _state.ae = _state.params.aS;
                                }
                                else
                                {
                                    if (_state.aeStage == int32_t {3})
                                    {
                                        _state.ae = (_state.ae - arT);
                                        if (_state.ae <= 0.0f)
                                        {
                                            _state.ae = 0.0f;
                                            _state.aeStage = int32_t {-1};
                        ...
                        posMod = (_state.params.waveEnv * _state.fe) + (_state.params.waveLfo * ((lfo * 0.5f) + 0.5f));
                        posA = intrinsics::clamp (_state.params.waveA + posMod, 0.0f, 1.0f);
                        posB = intrinsics::clamp ((_state.params.waveA + _state.params.waveB) + posMod, 0.0f, 1.0f);
                        tune = intrinsics::pow (2.0f, (_state.params.tune - 0.5f) * 0.16f);
                        vib = 1.0f + (lfo * 0.0025f);
                        det = _state.params.detune * 0.02f;
                        incA = intrinsics::clamp (((_state.freq * tune) * vib) * (1.0f - det), 0.0f, _state.sr * 0.49f) * _state.invSr;
                        _state.phA = (_state.phA + incA);
                        if (_state.phA >= 1.0f)
                        {
                            _state.phA = (_state.phA - 1.0f);
                        }
                        incB = intrinsics::clamp (((_state.freq * tune) * vib) * (1.0f + det), 0.0f, _state.sr * 0.49f) * _state.invSr;
                        _state.phB = (_state.phB + incB);
                        if (_state.phB >= 1.0f)
                        {
                            _state.phB = (_state.phB - 1.0f);
                        }
                        oA = PPGVoice__readWT (_state, posA, _state.phA);
                        oB = PPGVoice__readWT (_state, posB, _state.phB);
                        _state.subPh = (_state.subPh + (incA * 0.5f));
                        if (_state.subPh >= 1.0f)
                        {
                            _state.subPh = (_state.subPh - 1.0f);
                        }
                        subOsc = (((_state.subPh < 0.5f) ? 1.0f : -1.0f) * _state.params.sub) * 0.6f;
                        nz = (PPGVoice__rnd (_state) * _state.params.noise) * 0.5f;
                        gA = intrinsics::sqrt (intrinsics::clamp (1.0f - _state.params.mix, 0.0f, 1.0f)) + 0.35f;
                        gB = intrinsics::sqrt (intrinsics::clamp (_state.params.mix, 0.0f, 1.0f)) + 0.35f;
                        mix = ((((oA * gA) + (oB * gB)) * 0.5f) + subOsc) + nz;
                        if (_state.params.grit > 0.001f)
                        {
                            bits = 11.0f - (_state.params.grit * 7.0f);
                            q = intrinsics::pow (2.0f, bits);
                            gritted = intrinsics::floor ((mix * q) + 0.5f) / q;
                            mix = ((mix * (1.0f - _state.params.grit)) + (gritted * _state.params.grit));
                        }
                        kt = 1.0f + (_state.params.keytrk * ((_state.freq / 261.63f) - 1.0f));
                        fc = intrinsics::clamp (((30.0f * intrinsics::exp (_state.params.cutoff * 7.0f)) * kt) + ((_state.params.filtEnv * _state.fe) * 7000.0f), 25.0f, _state.sr * 0.45f);
                        g = intrinsics::tan ((3.1415927f * fc) * _state.invSr);
                        G = g / (1.0f + g);
                        res4 = _state.params.res * 4.2f;
                        inp = mix - (res4 * _state.l4);
                        _state.l1 = (_state.l1 + ((2.0f * G) * (intrinsics::tanh (inp * 0.8f) - intrinsics::tanh (_state.l1 * 0.8f))));
                        _state.l2 = (_state.l2 + ((2.0f * G) * (intrinsics::tanh (_state.l1 * 0.8f) - intrinsics::tanh (_state.l2 * 0.8f))));
                        _state.l3 = (_state.l3 + ((2.0f * G) * (intrinsics::tanh (_state.l2 * 0.8f) - intrinsics::tanh (_state.l3 * 0.8f))));
                        _state.l4 = (_state.l4 + ((2.0f * G) * (intrinsics::tanh (_state.l3 * 0.8f) - intrinsics::tanh (_state.l4 * 0.8f))));
                        sig = _state.l4;
                        yb = (sig - _state.dcx) + (0.9985f * _state.dcy);
                        _state.dcx = sig;
                        _state.dcy = yb;
                        sig = yb;
                        amp = ((sig * _state.ae) * (0.45f + (0.55f * _state.vel))) * (0.4f + (_state.params.volume * 1.2f));
                        pan = _state.vPan * 0.22f;
                        outL = intrinsics::tanh ((amp * intrinsics::sqrt (intrinsics::clamp (0.5f - (pan * 0.5f), 0.0f, 1.0f))) * 1.8f);
                        outR = intrinsics::tanh ((amp * intrinsics::sqrt (intrinsics::clamp (0.5f + (pan * 0.5f), 0.0f, 1.0f))) * 1.8f);
        ...
        void PPGVoice__buildTable (_PPGVoice_1_State& _state) noexcept
        {
            int32_t  w;
            float  pos;
            float  zone;
                ...
                for (;;)
                {
                        ...
                        for (;;)
                        {
                            ...
                            s = 0.0f;
                            {
                                ...
                                for (;;)
                                {
                                    ...
                                    saw = 1.0f / kf;
                                    sq = (intrinsics::modulo (k, int32_t {2}) == int32_t {1}) ? (1.0f / kf) : 0.0f;
                                    cF = 2.0f + (pos * 26.0f);
                                    dF = (kf - cF) / (1.6f + (pos * 4.5f));
                                    formant = intrinsics::exp ((-0.5f * dF) * dF);
                                    cH = 16.0f + (pos * 18.0f);
                                    dH = (kf - cH) / 5.0f;
                                    hi = intrinsics::exp ((-0.5f * dH) * dH);
                                    amp = 0.0f;
                                    if (zone < 1.0f)
                                    {
                                        m = zone;
                                        amp = (((k == int32_t {1}) ? (1.0f - m) : 0.0f) + (saw * (0.35f + (0.5f * m))));
                                    }
                                    else
                                    {
                                        if (zone < 2.0f)
                                        {
                                            m_0 = zone - 1.0f;
                                            amp = (((saw * (0.75f - (0.25f * m_0))) + (sq * (0.45f * m_0))) + (formant * (0.35f * m_0)));
                                        }
                                        else
                                        {
                                            m_1 = zone - 2.0f;
                                            amp = (((saw * 0.25f) + (formant * 0.65f)) + (hi * (0.55f * m_1)));
                                        }
                                    }
                                    s = (s + (amp * intrinsics::sin ((6.2831855f * kf) * ph)));
                                    {
                                        ++kk;
                                    }
                                }
                            }
                            _state.wt[std__intrinsics___wrap_16384 ((w * g_WL) + n)] = s;
                            a = intrinsics::abs (s);
                            if (a > maxv)
                            {
                                maxv = a;
                    ...
                    inv = 1.0f / maxv;
                    {
                        ...
                        for (;;)
                        {
                            ...
                            {
                                t = std__intrinsics___wrap_16384 ((w * g_WL) + n_0);
                                _state.wt[t] = (_state.wt[t] * inv);
                            }
                            {
                                ++n_0;
                            }
        ...
        float PPGVoice__readWT (_PPGVoice_1_State& _state, float pos, float phase) noexcept
        {
            float  fp;
            int32_t  w0;
            float  wf;
            ...
            fp = intrinsics::clamp (pos, 0.0f, 1.0f) * 63.0f;
            w0 = static_cast<int32_t> (fp);
            wf = fp - static_cast<float> (w0);
            w1 = intrinsics::min (w0 + int32_t {1}, int32_t {63});
            fph = phase - intrinsics::floor (phase);
            fi = fph * 256.0f;
            i0 = intrinsics::modulo (static_cast<int32_t> (fi), g_WL);
            i1 = intrinsics::modulo (i0 + int32_t {1}, g_WL);
            nf = fi - intrinsics::floor (fi);
            a0 = (_state.wt[std__intrinsics___wrap_16384 ((w0 * g_WL) + i0)] * (1.0f - nf)) + (_state.wt[std__intrinsics___wrap_16384 ((w0 * g_WL) + i1)] * nf);
            a1 = (_state.wt[std__intrinsics___wrap_16384 ((w1 * g_WL) + i0)] * (1.0f - nf)) + (_state.wt[std__intrinsics___wrap_16384 ((w1 * g_WL) + i1)] * nf);
            return (a0 * (1.0f - wf)) + (a1 * wf);
        }
        ...
        static _PPG_State& state_upcast_struct_PPG_State_struct__DM9Mxc (_ParamsProcessor_1_State& child) { return *reinterpret_cast<_PPG_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_PPG_State, paramsProcessor))); }
        static _PPG_State& state_upcast_struct_PPG_State_struct__DVMcGd (std_voices_std_voices_VoiceAllocator_specialised_Th5A4_1_State& child) { return *reinterpret_cast<_PPG_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_PPG_State, voiceAllocator))); }
        static _PPG_State& state_upcast_struct_PPG_State_struct__lKHNAe (std_midi_MPEConverter_1_State& child) { return *reinterpret_cast<_PPG_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_PPG_State, noteTap))); }
        static PPG_State& state_upcast_struct_PPG_State_struct__HUIvTb (_PPG_State& child) { return *reinterpret_cast<PPG_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (PPG_State, _state))); }
        static _PPG_State& state_upcast_struct_PPG_State_struct__KHvoye (std_midi_MPEConverter_1_State& child) { return *reinterpret_cast<_PPG_State*> (reinterpret_cast<char*> (std::addressof (child)) - (OFFSETOF (_PPG_State, mpe))); }
        ...
        double g__frequency {};
        static constexpr int32_t g_WL { int32_t {256} };
...
struct PPG
{
    using PerformerClass = performer::PPG;
    static constexpr auto filename = "PPG.cmajorpatch";
    ...
    static constexpr const char* cmaj_api_cmajpatchconnection_js =
        ...
        "    }\n"
        "}\n";
    static constexpr const char* PPG_cmajorpatch =
        "{\n"
        "  \"CmajorVersion\": 1,\n"
        "  \"ID\": \"com.plugincorp.jwppg\",\n"
        "  \"version\": \"0.1\",\n"
        "  \"name\": \"JW-PPG\",\n"
        "  \"description\": \"TOI JW-PPG - wavetable 8-voice poly by plugin corp\",\n"
        "  \"category\": \"instrument\",\n"
        "  \"manufacturer\": \"TOI\",\n"
        "  \"isInstrument\": true,\n"
    ...
    static constexpr std::array files =
    {
        ...
        File { "PPG.cmajorpatch", std::string_view (PPG_cmajorpatch, 364) },
...
// native faceplate (replaces the generic Cmajor UI). See PPGNative.h.
#include "PPGNative.h"

juce::AudioProcessor* JUCE_CALLTYPE createPluginFilter()
{
    return new PPGPlugin (std::make_shared<cmaj::Patch>());
}
